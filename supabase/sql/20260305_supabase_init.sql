-- Zenith v4 Supabase bootstrap SQL
-- Target: Supabase SQL Editor / Migration
...
create index if not exists idx_runs_strategy_time on public.text_runs (strategy_id, created_at desc);
create index if not exists idx_runs_status on public.text_runs (status);
...
create index if not exists idx_trades_run_entry on public.text_trades (run_id, entry_ts);
create index if not exists idx_trades_run_exit_reason on public.text_trades (run_id, exit_reason);
...
create index if not exists idx_system_event_logs_level_ts on public.text_system_event_logs (level, created_at desc);
create index if not exists idx_system_event_logs_type_ts on public.text_system_event_logs (event_type, created_at desc);
create index if not exists idx_system_event_logs_run_ts on public.text_system_event_logs (run_id, created_at desc);
...
create index if not exists idx_dead_letter_events_run_ts on public.text_dead_letter_events (run_id, created_at desc);
